...
TOKEN = '7682162295:AAEAIpmqUtPfBc5TwMaMK43PvZVI-WTK5Es'
bot = telebot.TeleBot(TOKEN, threaded=False)

# 🛡️ List of authorized user IDs (replace with actual IDs)
AUTHORIZED_USERS = [7374612242]
...
def start(message):
    ...
    if user_id not in AUTHORIZED_USERS:
        bot.send_message(message.chat.id, "🚫 𝑷𝑯𝑳𝑨 𝑲𝑯𝑹𝑰𝑫 𝑳𝑶 🥶🚭 DM TO BUY :- @TRUSTVIP_MOD0")
    else:
        welcome_message = (
            ...
            "📞 Contact the owner on Instagram and Telegram: @TRUSTVIP_MOD0\n"
...
def stop(message):
    ...
    if user_id not in AUTHORIZED_USERS:
        bot.send_message(message.chat.id, "🚫 Access Denied! Contact the owner for assistance: @TRUSTVIP_MOD0")
        return
...
def show_id(message):
    ...
    bot_owner = "@TRUSTVIP_MOD0"  # 👑 The bot owner's username  ⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆⋆｡ﾟ☁︎｡⋆｡ ﾟ☾ ﾟ｡⋆
...
def owner(message):
    ...
    bot.send_message(message.chat.id, "📞 Contact the owner: @TRUSTVIP_MOD0")
...
This bot is owned and operated by @TRUSTVIP_MOD0 on Telegram and TRUSTVIP on Instagram, 🇮🇳. By using this bot, you acknowledge that you understand and agree to the following terms:
...
* **🤝 INDEMNIFICATION**: You agree to indemnify and hold harmless @TRUSTVIP_MOD0 on Telegram and TRUST VIP, and its affiliates, officers, agents, and employees, from and against any and all claims, damages, obligations, losses, liabilities, costs or debt, and expenses (including but not limited to attorney's fees) arising from or related to your use of this bot.
* **🌐 THIRD-PARTY LINKS**: This bot may contain links to third-party websites or services, and you acknowledge that @TRUSTVIP_MOD0 on Telegram and TRUST VIP on Instagram is not responsible for the content, accuracy, or opinions expressed on such websites or services.
...
* **📝 ENTIRE AGREEMENT**: This disclaimer constitutes the entire agreement between you and @TRUSTVIP_MOD0 on Telegram and TRUST VIP on Instagram regarding your use of this bot, and supersedes all prior or contemporaneous agreements or understandings.
...
if __name__ == "__main__":
    ...
    print(" 👍 Bot is now online with @TRUSTVIP_MOD0 🤗 and ready to Ddos_attack! ▰▱▰▱▰▱▰▱▰▱▰▱▰▱")
